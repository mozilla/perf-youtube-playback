...
main() {
  ...
  CSP="\"content-security-policy\": \"default-src 'none'; img-src 'self' data:; media-src 'self' blob:; script-src 'self' 'unsafe-inline'; font-src 'self'; frame-ancestors 'none'; base-uri 'none'; style-src 'self' 'unsafe-inline'; connect-src 'self' https://dash-mse-test.appspot.com\""
